...
namespace Rocketcress.Selenium
{
    ...
    public abstract class SeleniumTestBase : SeleniumTestBase<Settings, SeleniumTestContext>
    {
        ...
        public static void Initialize<TSettings, TContext>(TSettings settings, TContext context, IDriverConfiguration driverConfiguration = null) where TSettings : Settings where TContext : SeleniumTestContext
        {
        ...
        /// </summary>
        /// <param name="context">The MSTest test context of the test.</param>
        public static void Cleanup<T>(T context) where T : SeleniumTestContext
        {
    ...
    [DeploymentItem("webdriver_prefs.json")]
    [AddKeysClass("SettingKeys")]
    public abstract class SeleniumTestBase<TSettings, TContext> : TestBase<TSettings, TContext>, IDriverConfiguration where TSettings : Settings where TContext : SeleniumTestContext
    {
        /// <summary>
        /// The currently focused Selenium web driver.
        /// </summary>
