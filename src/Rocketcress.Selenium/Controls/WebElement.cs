...
namespace Rocketcress.Selenium.Controls
{
    ...
    public class WebElement : TestObjectBase, IWebElement, IWrapsElement
    {
        ...
        /// <summary>
        /// Determines if the current element exists on the current page.
        /// </summary>
        ...
        /// <summary>
        /// Determines if the control is currently clickable.
        /// </summary>
        public bool IsClickable
        {
            get
            {
                try { return WrappedElement != null && WrappedElement.Displayed && WrappedElement.Enabled; }
        ...
        public WebElement(By locationKey) : this()
        {
        ...
        public WebElement(By locationKey, ISearchContext searchContext) : this()
        {
        ...
        public WebElement(IWebElement element) : this()
        {
        ...
        /// <summary>
        /// Waits for x seconds and clicks the element.
        /// </summary>
        public virtual void ClickAndWaitForSeconds(int waitInSeconds = 5)
        {
            Click();
        ...
        /// <summary>
        /// Clicks this element and wait for a next element.
        /// </summary>
        public virtual void ClickAndWaitForElement(WebElement element, bool newElementclick = false, int fallbackSleep = 5000, int waitBeforeClick = 500)
        {
            WaitUntilClickable();
            Click();
            element.WaitUntilClickable(fallbackSleep);
            if (newElementclick)
            {
        ...
        {
            try { Driver.GetActions().DoubleClick(WrappedElement).Perform(); }
        ...
        /// </summary>
        public virtual void RightClick() { Driver.GetActions().ContextClick(WrappedElement).Perform(); }
        ...
        public T? TryGetAttribute<T>(string attributeName, Func<string, T> converter) where T : struct
        {
            try
            {
            ...
            catch (NoSuchWindowException) { return null; }
        }
        ...
        {
            if (levels < 1)
                throw new ArgumentOutOfRangeException("The argument 'levels' has to be greater than 0!");
        ...
        public T GetParentElement<T>(int levels = 1) where T : WebElement
        {
            if (levels < 1)
                throw new ArgumentOutOfRangeException("The Argument 'levels' has to be greater than 0!");
            var xPath = string.Join("/", Enumerable.Range(0, levels).Select(x => ".."));
        ...
        public string GetSearchDescription(bool multiline = false)
        {
            ...
            return result + (multiline ? Environment.NewLine + "   " : "") + " => " + (o ?? "(null)");
        }
        ...
        public T FindAncestorSearchContext<T>(bool matchExactType) where T : class, ISearchContext
        {
        ...
        /// </remarks>
        public virtual void Clear() { WrappedElement.Clear(); }
        /// <summary>
        /// Clicks this element.
        /// </summary>
        /// <remarks>
        ...
        public virtual void Click(bool forceClick)
        {
            ...
            if (!forceClick)
            {
                if (!WaitUntilDisplayed(5000, false) || !WaitUntilClickable(5000, false))
                    ScrollIntoView();

                if (WaitUntilClickable(5000, false))
                {
                    try
                    {
        ...
        /// </returns>
        public virtual IWebElement FindElement(By by) { return WrappedElement.FindElement(by); }
        /// <summary>
        ...
        /// </returns>
        public virtual ReadOnlyCollection<IWebElement> FindElements(By by) { return WrappedElement.FindElements(by); }
        /// <summary>
        ...
        /// </remarks>
        public virtual string GetAttribute(string attributeName) { return WrappedElement.GetAttribute(attributeName); }
        /// <summary>
        ...
        /// </remarks>
        public virtual string GetCssValue(string propertyName) { return WrappedElement.GetCssValue(propertyName); }
        /// <summary>
        ...
        /// </remarks>
        public virtual void Submit() { WrappedElement.Submit(); }
        #endregion
        ...
        private static string GetStringForElement(IWebElement element, IJavaScriptExecutor javaScript)
        {
            ...
            try { attributes = javaScript.ExecuteScript("var items = {}; for (index = 0; index < arguments[0].attributes.length; ++index) { items[arguments[0].attributes[index].name] = arguments[0].attributes[index].value }; return items;", element) as ICollection<string> ?? new string[0]; }
            catch { attributes = Array.Empty<string>(); }
            return string.Format("<{0}{1}>...</{0}>", element.TagName, attributes.Count > 0 ? " " + string.Join(" ", attributes) : "");
        }
        ...
        public static T GetElement<T>(By locationKey) where T : WebElement
        {
        ...
        /// <returns>A element of type <typeparamref name="T"/>.</returns>
        public static T GetElement<T>(By locationKey, ISearchContext searchContext) where T : WebElement
        {
        ...
        {
            try { return element == null || !element.Enabled; }
