...
namespace Rocketcress.Core
{
    ...
    {
        /// <summary>
        /// A data store you can use on another event on this waiting operation.
        /// </summary>
        public Dictionary<string, object> DataStore { get; }

        /// <summary>
        /// Initializes a new instance of the WaitingEventArgs class.
        /// </summary>
    ...
    {
        /// <summary>
        /// The exception object that has been thrown during the waiting operation.
        /// </summary>
    ...
    public static class Waiter
    {
        ...
        /// <summary>
        /// Determines whether exceptions during waiting operations should be traced.
        /// </summary>
        public static bool TraceExceptions { get; set; }
        /// <summary>
        /// The maximal accepted exceptions during waiting operations. If more that the specified exceptions are thrown the waiting operation fails.
        /// If the value is set to null, the accepted exceptions are infinite.
        /// </summary>
        public static int? MaxAcceptedExceptions { get; set; }
        /// <summary>
        /// The default timeout for waiting operations.
        /// </summary>
        public static TimeSpan DefaultTimeout { get; set; }
        /// <summary>
        /// The default timeout for waiting operations in miliseconds.
        /// </summary>
        public static int DefaultTimeoutMs => (int)DefaultTimeout.TotalMilliseconds;
        /// <summary>
        /// The time to wait between checking during a waiting operation.
        /// </summary>
        ...
        private static bool HandleException(ref int exceptionCount, Action<Exception> callback, Exception exception)
        {
            ...
            try { callback?.Invoke(exception); }
            catch(Exception ex) { Logger.LogWarning("Excpetion while calling error-callback: " + ex); }

            try { ExceptionOccured?.Invoke(null, new ExceptionEventArgs(exception)); }
            catch(Exception ex) { Logger.LogWarning("Exception while calling event 'ExcpetionOccured': " + ex); }
