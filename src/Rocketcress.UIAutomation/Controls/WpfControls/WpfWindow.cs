...
/// <summary>
/// Represents a Windows Presentation Foundation window control.
/// </summary>
...
public partial class WpfWindow : WpfControl, IUITestWindowControl
{
    ...
    /// </summary>
    /// <param name="app">The application the window is part of.</param>
    ...
    /// </summary>
    /// <param name="app">The application the window is part of.</param>
    /// <param name="locationKey">The location key that is used to find the window.</param>
