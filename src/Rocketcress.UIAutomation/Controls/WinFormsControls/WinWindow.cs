...
/// <summary>
/// Represents a Windows Forms window control.
/// </summary>
...
[AutoDetectControl]
[GenerateUIMapParts]
public partial class WinWindow : WinControl, IUITestWindowControl
{
    /// <inheritdoc/>
    ...
    /// </summary>
    /// <param name="app">The application this window is part of.</param>
    /// <param name="locationKey">The location key that is used to find this window.</param>
    public WinWindow(Application app, By locationKey)
