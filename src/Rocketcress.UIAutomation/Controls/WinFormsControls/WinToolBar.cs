...
namespace Rocketcress.UIAutomation.Controls.WinFormsControls
{
    ...
    public class WinToolBar : WinControl, IUITestToolBarControl
    {
        ...
        #region Construcotrs
        public WinToolBar(By locationKey)
            : base(locationKey)
        {
        }

        public WinToolBar(IUITestControl parent)
            : base(parent)
        {
        }

        public WinToolBar(AutomationElement element)
            : base(element)
        {
        }

        public WinToolBar(By locationKey, AutomationElement parent)
            : base(locationKey, parent)
        {
        }

        public WinToolBar(By locationKey, IUITestControl parent)
            : base(locationKey, parent)
        {
        }
