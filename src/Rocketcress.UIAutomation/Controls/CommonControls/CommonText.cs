...
namespace Rocketcress.UIAutomation.Controls.CommonControls
{
    ...
    public class CommonText : UITestControl, IUITestTextControl
    {
        ...
        public CommonText(By locationKey)
            : base(locationKey)
        {
        }

        public CommonText(IUITestControl parent)
            : base(parent)
        {
        }

        public CommonText(AutomationElement element)
            : base(element)
        {
        }

        public CommonText(By locationKey, AutomationElement parent)
            : base(locationKey, parent)
        {
        }

        public CommonText(By locationKey, IUITestControl parent)
            : base(locationKey, parent)
        {
        }
