...
namespace Rocketcress.UIAutomation.Controls.CommonControls
{
    ...
    public class CommonPane : UITestControl, IUITestTextControl
    {
        ...
        public CommonPane(By locationKey)
            : base(locationKey)
        {
        }

        public CommonPane(IUITestControl parent)
            : base(parent)
        {
        }

        public CommonPane(AutomationElement element)
            : base(element)
        {
        }

        public CommonPane(By locationKey, AutomationElement parent)
            : base(locationKey, parent)
        {
        }

        public CommonPane(By locationKey, IUITestControl parent)
            : base(locationKey, parent)
        {
        }
