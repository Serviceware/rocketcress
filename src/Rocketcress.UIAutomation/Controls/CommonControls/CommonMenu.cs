...
namespace Rocketcress.UIAutomation.Controls.CommonControls
{
    ...
    public class CommonMenu : UITestControl, IUITestMenuControl
    {
        ...
        #region Constructors
        public CommonMenu(By locationKey) : base(locationKey) { }
        public CommonMenu(IUITestControl parent) : base(parent) { }
        public CommonMenu(AutomationElement element) : base(element) { }
        public CommonMenu(By locationKey, AutomationElement parent) : base(locationKey, parent) { }
        public CommonMenu(By locationKey, IUITestControl parent) : base(locationKey, parent) { }
