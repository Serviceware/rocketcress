...
namespace Rocketcress.UIAutomation.Controls.CommonControls
{
    ...
    public class CommonWindow : UITestControl, IUITestWindowControl
    {
        ...
        #region Constructors
        public CommonWindow(AutomationElement element) : base(element) { }
        public CommonWindow(Application app) : this(By.Empty, app) { }
        public CommonWindow(By locationKey) : base(locationKey) { }
        public CommonWindow(IUITestControl parent) : base(parent) { }
        public CommonWindow(By locationKey, AutomationElement parent) : base(locationKey, parent) { }
        public CommonWindow(By locationKey, IUITestControl parent) : base(locationKey, parent) { }
        public CommonWindow(By locationKey, Application app) : base(locationKey)
        {
            _application = app;
            if (app != null)
