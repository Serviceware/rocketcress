...
/// <summary>
/// Represents a common window control.
/// </summary>
...
public partial class CommonWindow : UITestControl, IUITestWindowControl
{
    ...
    /// </summary>
    /// <param name="app">The application the window is attached to.</param>
    ...
    /// </summary>
    /// <param name="app">The application the window is attached to.</param>
    /// <param name="locationKey">The location key that is used to find the control.</param>
