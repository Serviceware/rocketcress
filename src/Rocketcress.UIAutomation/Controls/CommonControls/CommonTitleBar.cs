...
namespace Rocketcress.UIAutomation.Controls.CommonControls
{
    ...
    public class CommonTitleBar : UITestControl, IUITestTitleBarControl
    {
        ...
        #region Constructors
        public CommonTitleBar(By locationKey) : base(locationKey) { }
        public CommonTitleBar(IUITestControl parent) : base(parent) { }
        public CommonTitleBar(AutomationElement element) : base(element) { }
        public CommonTitleBar(By locationKey, AutomationElement parent) : base(locationKey, parent) { }
        public CommonTitleBar(By locationKey, IUITestControl parent) : base(locationKey, parent) { }
