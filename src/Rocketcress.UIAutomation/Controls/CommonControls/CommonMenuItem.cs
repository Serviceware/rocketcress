...
namespace Rocketcress.UIAutomation.Controls.CommonControls
{
    ...
    public class CommonMenuItem : UITestControl, IUITestMenuItemControl
    {
        ...
        public CommonMenuItem(By locationKey)
            : base(locationKey)
        {
        }

        public CommonMenuItem(IUITestControl parent)
            : base(parent)
        {
        }

        public CommonMenuItem(AutomationElement element)
            : base(element)
        {
        }

        public CommonMenuItem(By locationKey, AutomationElement parent)
            : base(locationKey, parent)
        {
        }

        public CommonMenuItem(By locationKey, IUITestControl parent)
            : base(locationKey, parent)
        {
        }
