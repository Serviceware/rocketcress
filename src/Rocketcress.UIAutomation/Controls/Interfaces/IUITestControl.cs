...
namespace Rocketcress.UIAutomation.Controls
{
    public interface IUITestControl
    {
        ...
        bool IsPatternAvailable<T>() where T : BasePattern;
        /// <summary>
        ...
        bool TryGetPattern<T>(out T pattern) where T : BasePattern;
        ...
        T FindAncestorSearchContext<T>(bool matchExactType) where T : UITestControl;
