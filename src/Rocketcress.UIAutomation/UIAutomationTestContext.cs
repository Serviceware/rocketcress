...
namespace Rocketcress.UIAutomation
{
    ...
    public class UIAutomationTestContext : WindowsTestContextBase
    {
        ...
        protected static T CreateContext<T>(Func<T> activationFunc, Settings settings, TestContext testContext, Action<T> initAction) where T : UIAutomationTestContext
        {
