...
|------|-----------|-------------|
| Rocketcress.Core | [![NuGet](https://img.shields.io/nuget/vpre/Serviceware.Rocketcress.Core.svg)](https://www.nuget.org/packages/Serviceware.Rocketcress.Core/absoluteLatest/) | Contains core functionality of for all Rocketcress libraries and tests. |
| Rocketcress.Core.Windows | [![NuGet](https://img.shields.io/nuget/vpre/Serviceware.Rocketcress.Core.Windows.svg)](https://www.nuget.org/packages/Serviceware.Rocketcress.Core.Windows/absoluteLatest/) | Contains core functionality specifically for Windows of for all Rocketcress libraries and tests. |
| Rocketcress.Composition | [![NuGet](https://img.shields.io/nuget/vpre/Serviceware.Rocketcress.Composition.svg)](https://www.nuget.org/packages/Serviceware.Rocketcress.Composition/absoluteLatest/) | Extends Rocketcress.Core with System.ComponentModel.Composition specific functionalities. |
| Rocketcress.Mail | [![NuGet](https://img.shields.io/nuget/vpre/Serviceware.Rocketcress.Mail.svg)](https://www.nuget.org/packages/Serviceware.Rocketcress.Mail/absoluteLatest/) | Extends Rocketcress.Core with e-mail functionality. |
| Rocketcress.Selenium | [![NuGet](https://img.shields.io/nuget/vpre/Serviceware.Rocketcress.Selenium.svg)](https://www.nuget.org/packages/Serviceware.Rocketcress.Selenium/absoluteLatest/) | You can reference this library if you want to write tests using the [Selenium](https://github.com/SeleniumHQ/selenium) framework. |
| Rocketcress.SourceGenerators | [![NuGet](https://img.shields.io/nuget/vpre/Serviceware.Rocketcress.SourceGenerators.svg)](https://www.nuget.org/packages/Serviceware.Rocketcress.SourceGenerators/absoluteLatest/) | Contains C# 9.0 Source Generators that are useful to test projects. |
| Rocketcress.UIAutomation | [![NuGet](https://img.shields.io/nuget/vpre/Serviceware.Rocketcress.UIAutomation.svg)](https://www.nuget.org/packages/Serviceware.Rocketcress.UIAutomation/absoluteLatest/) | You can reference this library if you want to write tests using the [UIAutomation](https://docs.microsoft.com/en-us/dotnet/framework/ui-automation/ui-automation-overview) framework. |

The following packages are also available as Slim variants which do not require a reference to MSTest v2:
| Name | NuGet.org |
|------|-----------|
| Rocketcress.Core.Slim | [![NuGet](https://img.shields.io/nuget/vpre/Serviceware.Rocketcress.Core.Slim.svg)](https://www.nuget.org/packages/Serviceware.Rocketcress.Core.Slim/absoluteLatest/) |
| Rocketcress.Core.Windows.Slim | [![NuGet](https://img.shields.io/nuget/vpre/Serviceware.Rocketcress.Core.Windows.Slim.svg)](https://www.nuget.org/packages/Serviceware.Rocketcress.Core.Windows.Slim/absoluteLatest/) |
| Rocketcress.Composition.Slim | [![NuGet](https://img.shields.io/nuget/vpre/Serviceware.Rocketcress.Composition.Slim.svg)](https://www.nuget.org/packages/Serviceware.Rocketcress.Composition.Slim/absoluteLatest/) |
| Rocketcress.Mail.Slim | [![NuGet](https://img.shields.io/nuget/vpre/Serviceware.Rocketcress.Mail.Slim.svg)](https://www.nuget.org/packages/Serviceware.Rocketcress.Mail.Slim/absoluteLatest/) |
| Rocketcress.Selenium.Slim | [![NuGet](https://img.shields.io/nuget/vpre/Serviceware.Rocketcress.Selenium.Slim.svg)](https://www.nuget.org/packages/Serviceware.Rocketcress.Selenium.Slim/absoluteLatest/) |
| Rocketcress.UIAutomation.Slim | [![NuGet](https://img.shields.io/nuget/vpre/Serviceware.Rocketcress.UIAutomation.Slim.svg)](https://www.nuget.org/packages/Serviceware.Rocketcress.UIAutomation.Slim/absoluteLatest/) |
